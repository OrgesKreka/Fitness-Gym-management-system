    ...
    <div class="modal-dialog modal-lg">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body" style="padding:30px 40px;">
          ...
          <form class="form-horizontal" method="POST" action="http://localhost/palestra/includes/regjistrohu.php" onsubmit="return kontrolloTeDhenat();" enctype="multipart/form-data">
            <fieldset>
            ...
            <div class="form-group">
              ...
              <div class="col-md-6">
                <button id="submit" name="submit_a" class="btn btn-primary">Regjistrohu</button>
                <button class="btn btn-danger pull-right" type="reset">Dil</button>
              </div>
            </div>
